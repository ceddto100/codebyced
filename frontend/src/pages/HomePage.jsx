    ...
    <section className="mb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div className="relative pb-3">
          <h2 className="text-2xl font-bold text-gray-100 mb-1">Our Services</h2>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {services.map((service) => (
          <Link
            key={service.id}
            to={service.path}
            className="group backdrop-blur-sm bg-gray-900/80 rounded-lg p-6 shadow-lg hover:shadow-xl 
                     transition-all duration-300 border border-gray-800 relative overflow-hidden 
                     transform hover:-translate-y-1 hover:border-blue-500/50"
          >
            {/* Decorative Elements */}
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-blue-500/5 rounded-full 
                          group-hover:bg-blue-500/10 transition-all duration-300"></div>
            <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-indigo-500/5 rounded-full 
                          group-hover:bg-indigo-500/10 transition-all duration-300"></div>

            {/* Content */}
            <div className="relative z-10">
              <div className="flex items-center mb-4">
                <div className="p-3 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg 
                              text-white shadow-lg group-hover:shadow-blue-500/25 transition-all duration-300">
                  {service.icon}
                </div>
                <h3 className="ml-4 text-xl font-semibold text-gray-100 group-hover:text-blue-400 
