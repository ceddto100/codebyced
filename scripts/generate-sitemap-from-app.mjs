// /scripts/generate-sitemap-from-app.mjs
...
const APP_PATH = resolve(__dirname, "../frontend/src/App.jsx");
...
const LOCAL_BLOG_SLUGS = resolve(__dirname, "../frontend/src/data/blogSlugs.json");
...
if (blogParamRoute) {
  ...
  if (blogSlugs.length) {
    ...
    // If no slugs, keep just the /blog listing page (already in staticPaths if defined)
  }
}
